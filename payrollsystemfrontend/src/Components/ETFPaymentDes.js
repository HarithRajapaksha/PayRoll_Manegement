...
function EtfPaymentsDes() {
  ...
  const generatePDF = async () => {
    ...
    tempDiv.innerHTML = `
      <div style="padding: 20px; font-family: Arial, sans-serif;">
        <div style="text-align: center; margin-bottom: 30px;">
          ...
          <h3 style="margin: 10px 0; color: #666;">ETF Report - ${monthName} ${selectedYear}</h3>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
          <thead>
            <tr style="background-color: #343a40; color: white;">
              ...
              <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">ETF Contribution (3%)</th>
            </tr>
          </thead>
          <tbody>
            ${etfData.map(item => `
              <tr style="border-bottom: 1px solid #ddd;">
                ...
                <td style="border: 1px solid #ddd; padding: 8px;">Rs. ${(item.ETF || 0).toLocaleString()}</td>
              </tr>
            `).join('')}
          </tbody>
        </table>
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>ETF_Report_${monthName}_${selectedYear}.pdf</title>
        <style>
          @page { margin: 0.5in; }
    ...
    <div className="container mt-4">
      <div className="row">
        <div className="col-12">
          <h2 className="mb-4">ETF Data Report</h2>
            ...
            <>
              ...
              <div className="card mb-4">
                <div className="card-header">
                  <h4>ETF Data for {getMonthName(selectedMonth)} {selectedYear}</h4>
                </div>
                <div className="card-body">
